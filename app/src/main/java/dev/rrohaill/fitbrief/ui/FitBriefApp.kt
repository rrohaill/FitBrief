...
fun FitBriefApp(
    ...
    val onEvent: (FitBriefEvent) -> Unit = { event ->
        when (event) {
            ...
            FitBriefEvent.GenerateSummary -> viewModel.generateSummary()
            FitBriefEvent.CloseSummary -> viewModel.closeSummaryDetail()
            FitBriefEvent.OpenSettings -> viewModel.openSettings()
            FitBriefEvent.CloseSettings -> viewModel.closeSettings()
