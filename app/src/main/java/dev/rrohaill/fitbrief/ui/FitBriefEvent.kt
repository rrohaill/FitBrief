...
sealed interface FitBriefEvent {
    ...
    data object GenerateSummary : FitBriefEvent
    data object CloseSummary : FitBriefEvent
    data object OpenSettings : FitBriefEvent
    data object CloseSettings : FitBriefEvent
